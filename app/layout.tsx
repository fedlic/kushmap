  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-KMJGDV236F" />
        <script dangerouslySetInnerHTML={{ __html: `window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments);}gtag('js',new Date());gtag('config','G-KMJGDV236F');` }} />
